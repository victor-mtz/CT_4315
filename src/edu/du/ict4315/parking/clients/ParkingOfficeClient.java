...
public class ParkingOfficeClient {
    ...
    public static void sampleTransactions(RealParkingOffice office) {
        ...
        // Park a car
        ParkingTransaction pt1 = office.park(LocalDateTime.now(), office.getParkingPermit(permit1), lot);
        ParkingTransaction pt2 = office.park(LocalDateTime.now(), office.getParkingPermit(permit2), lot);

        System.out.println(pt1);
        System.out.println(pt2);

        // List customers
        String[] custIds = office.getCustomerIds();
        System.out.println("Customers: " + String.join(", ", custIds));

        // List parking lots
        String[] lotIds = office.getLotIds();
        System.out.println("Lot ids: " + String.join(", ", lotIds));
